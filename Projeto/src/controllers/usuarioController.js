            ...
            .then(
                function (resultadoAutenticar) {
                    ...
                    if (resultadoAutenticar.length == 1) {
                        ...
                        const d = new Date(resultadoAutenticar[0].data_cadastro);
...
function cadastrar(req, res) {
    ...
    var telefoneR = req.body.telefoneRServer;
    ...
    if (nome == undefined) {
        ...
        usuarioModel.cadastrar(nome, data, email, telefone, endereco, nomeR, telefoneR, condicao, senha)
            .then(
                function (resultado) {
                    res.json(resultado);
                }
